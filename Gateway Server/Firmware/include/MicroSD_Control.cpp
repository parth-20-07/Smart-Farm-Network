...
{
    Serial.println("Writing file: " + str_path);
    Serial.println("Write Message: " + msg);
...
{
    Serial.println("Appending file: " + str_path);
    Serial.println("Appending Message: " + msg);
    char path[str_path.length()];
    strcpy(path, str_path.c_str());
